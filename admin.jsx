// Screen 3 — Admin / Gabbai Dashboard (bilingual)
const AdminScreen = () => {
  const tx = useTx();
  ...
  // Re-seed editable fields when language flips
  const { lang } = useLang();
  React.useEffect(() => {
  ...
  const sideLinks = [
    { gHe: "מבט-על", gEn: "Overview", items: [
      { he: "סקירה כללית", en: "Dashboard", c: 0, active: true, icon: <I.Sparkles /> },
      { he: "יומן והתראות", en: "Journal & alerts", c: 7, icon: <I.Bell /> },
    ]},
    { gHe: "קהילה", gEn: "Community", items: [
      { he: "אירועים", en: "Events", c: 14, icon: <I.Calendar /> },
      { he: "חברי הקהילה", en: "Members", c: 287, icon: <I.Users /> },
      { he: "תפילות ומניינים", en: "Tefillot & minyanim", c: 3, icon: <I.Book /> },
      { he: "תבניות הפעלה", en: "Templates", c: 22, icon: <I.Bolt /> },
    ]},
    { gHe: "פיננסי", gEn: "Finance", items: [
      { he: "תרומות וגבייה", en: "Donations & dues", c: 6, icon: <I.Coins /> },
      { he: "דוחות חודשיים", en: "Monthly reports", c: null, icon: <I.TrendUp /> },
    ]},
    { gHe: "מערכת", gEn: "System", items: [
      { he: "הגדרות הקהילה", en: "Community settings", c: null, icon: <I.Settings /> },
    ]},
  ];
        ...
        <div className="admin-main">
          ...
          <div className="kpi-row">
            ...
            <div className="kpi-card">
              ...
              <div className="label">{tx("נגבה החודש", "Collected this month")}</div>
